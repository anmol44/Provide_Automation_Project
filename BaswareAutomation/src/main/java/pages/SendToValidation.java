...
public class SendToValidation extends BasePage {
	...
	public SendToValidation(WebDriver driver) {
		super(driver);
	}
	
	
	public SendToValidation receivedStage() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(recievedStageXpath))).click();
		return this;
	}
	
	
	public SendToValidation invoiceSearch(String invoice)  {
	...
	public SendToValidation  savePoInvoice(String invoice,String po,String supplierCode,String invoiceDate,String invoiceAmt,String taxAmt) throws InterruptedException  {
	...
	public SendToValidation editNonPoInvoice(String invoice,String prType,String supplierCode,String invoiceDate,String invoiceAmt,String taxAmt,String approver) throws InterruptedException  {
	...
	public SendToValidation saveAndAddLines(JavascriptExecutor javascriptExecutor, String lines,String purchaseCategoryList,String agencyList,String typeList,String sspList) throws InterruptedException  {
	...
	public SendToValidation sendToValidate() throws InterruptedException  {
	...
	public SendToValidation searchInvoice(String invoice) throws InterruptedException  {
		receivedStage().
